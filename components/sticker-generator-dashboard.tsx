...
import { PlusCircle, Image as ImageIcon, Settings, HelpCircle, Upload, Sparkles, Zap, Plus, User, LogOut, CreditCard, Moon, Sun, ChevronDown, Menu } from "lucide-react"
          ...
          <div className="max-w-3xl w-full space-y-6">
            <div className="space-y-2 relative">
              <div className="text-center mb-4">
                ...
                <p className={`text-sm md:text-base ${theme === 'dark' ? 'text-gray-300' : 'text-gray-700'}`}>Let's create something fun together! Stickers, ideas, and endless creativity await!</p>
              </div>
