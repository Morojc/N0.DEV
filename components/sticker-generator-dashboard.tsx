...
export default function StickerGeneratorDashboard() { 
  ...
  return (
    <div className={`relative min-h-screen overflow-hidden flex flex-col ${theme === 'dark' ? 'bg-gray-900 text-white' : ''}`}>
      <BackgroundLines />
      ...
      <div className="relative z-10 flex flex-1">
        ...
        <div className="flex-1 flex flex-col">
          <header className={`h-16 backdrop-blur-sm border-b ${theme === 'dark' ? 'border-gray-700' : 'border-gray-200'} p-4 relative z-10 flex items-center`}>
            <StyledAnimatedLogo />
          </header>
